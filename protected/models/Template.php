...
class Template extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('template_id, template_alias, template_title, template_subject, template_content, template_parameters, created_date, updated_date, template_status', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('template_alias', trim($this->template_alias), true);
        $criteria->compare('template_title', trim($this->template_title), true);
        $criteria->compare('template_subject', trim($this->template_subject), true);
    ...
    public static function getTemplate($template_alias) {
        $result = Template::model()->findByAttributes(array('template_alias' => $template_alias));
        return $result;
    }
