        ...
        <ul id="side" class="nav navbar-nav side-nav">
            ...
            <li class="side-user hidden-xs">
                <?php if ($this->user_data["user_avatar"] == NULL || $this->user_data["user_avatar"] == "") { ?>
                    <img class="img-circle" src="<?php echo Yii::app()->request->baseUrl; ?>/img/CUST_CARE.jpg" alt="">
                <?php } else { ?>
            ...
            if (Yii::app()->session['user_rights'][4]) {
                ...
                <li>
                    <a class="active" href="<?php echo Yii::app()->request->baseUrl; ?>/customer/tickets">
            ...
            <!-- begin Users LINK -->
            <li>
                <a class="active" href="<?php echo Yii::app()->request->baseUrl; ?>/customer/AddTicket">
