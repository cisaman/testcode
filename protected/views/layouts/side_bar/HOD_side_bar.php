        ...
        <ul id="side" class="nav navbar-nav side-nav">
            ...
            <li class="side-user hidden-xs">
                ...
                <p class="name tooltip-sidebar-logout">
                    <?php echo $this->user_data["accountType_name"]; ?><br/>
                    (<?php echo $this->user_data["department_name"]; ?>) <br/>
            ...
            <!-- <li>
                <a class="active" href="<?php // echo Yii::app()->request->baseUrl;      ?>/head/tickets">
                    <i class="fa fa-dashboard"></i> Tickets
                </a>
            </li> -->
            <!-- end DASHBOARD LINK -->

            <!-- begin addTicket LINK -->
            <li>
                <a class="active" href="<?php echo Yii::app()->request->baseUrl; ?>/head/openticket">
            ...
            if (Yii::app()->session['user_rights'][4]) {
                ?>
                <!-- begin Ticket list LINK -->
                <li>
                    <a class="active" href="<?php echo Yii::app()->request->baseUrl; ?>/head">
                        <i class="fa fa-table"></i>Department Tickets
                    </a>
                </li>
                <!-- end Users LINK -->
                <?php
            ...
            if (Yii::app()->session['user_rights'][2]) {
                ...
                <!-- begin Users LINK -->
                <li>
                    <a class="active" href="<?php echo Yii::app()->request->baseUrl; ?>/head/users">
                        <i class="fa fa-table"></i> Department Users
                    </a>
                </li>
                <!-- end Users LINK -->
                <?php
